...
-include("/home/jonjon/repos/otp/lib/ssh/src/ssh.hrl").
-include("/home/jonjon/repos/otp/lib/ssh/src/ssh_agent.hrl").
...
send(Request, Opts) ->
    ...
    % First get the length bytes to know how data we should request, then 
    % request that amount of expected data from the agent
